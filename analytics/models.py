...
class ObjectViewed(models.Model):
    ...
    content_type = models.ForeignKey(ContentType, on_delete=models.CASCADE) #User, Product, Order, Cart..
    object_id = models.PositiveIntegerField() # User_id, Products_id
    ...
    class Meta:
        ...
        verbose_name_plural = 'Objects views'
